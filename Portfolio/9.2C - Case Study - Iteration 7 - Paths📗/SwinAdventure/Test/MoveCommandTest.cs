...
namespace SwinAdventure
{
    public class MoveCommandTest
    {
        ...
        public void TestCouldNotFindPaths()
        {
            ...
            Assert.AreEqual($"Could not find the {sword.Name}.", _testMoveCommand.Execute(_testPlayer, new string[] { "move", "sword" }));

            // and the player remains in the same location
            Assert.AreEqual(_testPlayer.Location, _studio);

            // Location locates nothing
            Assert.AreEqual("Could not find the path.", _testMoveCommand.Execute(_testPlayer, new string[] { "go", "west" }));
            Assert.AreEqual("Could not find the path.", _testMoveCommand.Execute(_testPlayer, new string[] { "go", "southwest" }));
            Assert.AreEqual("Could not find the path.", _testMoveCommand.Execute(_testPlayer, new string[] { "go", "gun" }));
