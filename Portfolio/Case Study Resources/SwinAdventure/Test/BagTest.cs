namespace SwinAdventure
{
    public class BagTest
    {
        ...
        public void TestBagLocatesItems()
        {
            ...
            Assert.AreNotEqual(_b1.Locate(_computer.FirstId), _computer);
        ...
        public void TestBagInBag()
        {
            ...
            Assert.AreNotEqual(_b1.Locate(_gun.FirstId), _gun);
            Assert.AreNotEqual(_b1.Locate(_rifle.FirstId), _rifle);
            Assert.AreNotEqual(_b1.Locate(_sycthe.FirstId), _sycthe);
        }
    }
}
